...
class _$_Popular implements _Popular {
  ...
  @override
  String toString() {
    return 'Popular(backdropPath: $backdropPath, genres: $genres, id: $id, overview: $overview, popularity: $popularity, posterPath: $posterPath, releaseDate: $releaseDate, runtime: $runtime, tagline: $tagline, title: $title, imdbId: $imdbId, voteAverage: $voteAverage)';
  }
