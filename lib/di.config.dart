...
import 'src/domain/repository/remote/api_repository.dart' as _i5; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i5.APIRepository>(() => _i5.APIRepository(get<_i3.Dio>(), baseUrl: get<String>(instanceName: 'BaseUrl')));
  return get;
}
